/////////////////////////////////
void Start_can1_R() { // โค้ดวิ่ง เริ่มต้น Can1 แล้วกระป๋องคือสีแดง
  InCan(3);
  LL(4, 1);
  PlaceCan("R");
...
void Start_can1_Y() { // โค้ดวิ่ง เริ่มต้น Can1 แล้วกระป๋องคือสีเหลือง
  InCan(2);
  SM(3);
  PlaceCan("Y2");
...
void Start_can2_Y() { // โค้ดวิ่ง เริ่มต้น Can2 แล้วกระป๋องคือสีเหลือง
  InCan(1);
  SM(1);
  PlaceCan("Y");
...
void Start_can2_G() { // โค้ดวิ่ง เริ่มต้น Can2 แล้วกระป๋องคือสีเเขียว
  InCan(3);
  RR(4, 1);
  PlaceCan("G");
...
void can1_R() { // โค้ดวิ่ง Can1 คือสีแดง
  InCan(3);
  LL(4, 1);
  PlaceCan("R");
...
void can1_Y() { // โค้ดวิ่ง Can1 คือสีเหลือง
  InCan(2);
  SM(3);
  PlaceCan("Y");
...
void can1_G() { // โค้ดวิ่ง Can1 คือสีเขียว
  InCan(2);
  SM(2);
  RR(4, 1);
  PlaceCan("G");
...
void can2_R() { // โค้ดวิ่ง Can2 คือสีแดง
  InCan(1);
  SM(2);
  LL(4, 1);
  PlaceCan("R");
...
void can2_Y() { // โค้ดวิ่ง Can2 คือสีเหลือง
  InCan(1);
  SM(1);
  PlaceCan("Y");//
  RR_SM();
...
void can2_G() { // โค้ดวิ่ง Can2 คือสีเขียว
  InCan(3);
  RR(4, 1);
  PlaceCan("G");
...
void can3(int target) { // โค้ดวิ่ง Can3
  if (target != 0) {
    LL(4, 1);
    InCan(1);
    RR(4, 1);

    GoTarget(target); // กำหนดสีอะไร จะวิ่งไปวางสีนั้นๆ
  }
}

void can4(int target) { // โค้ดวิ่ง Can4
  if (target != 0) {
    RR(4, 1);
    InCan(2);
    LL(4, 1);

    GoTarget(target); // กำหนดสีอะไร จะวิ่งไปวางสีนั้นนๆ
  }
}

void can5(int target) { // โค้ดวิ่ง Can5
  if (target != 0) {
    FF(4);
    LL(1, 2);
    InCan(1);
...
void can6(int target) { // โค้ดวิ่ง Can6
  if (target != 0) {
    FF(4);
    RR(1, 2);
    InCan(2);
...
void can15(int target) {
  if (target != 0) {
    ...
    GoTarget(target, "Finish"); // กำหนดสีอะไร จะวิ่งไปวางสีนั้นนๆ
  }
  else {
    FF(4);
    FF(1); // FF(1);
